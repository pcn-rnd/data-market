const projectData = [
    ...
    },
    {
        ...
        users: [require('@/assets/images/users/avatar-5.jpg'), 'A', require('@/assets/images/users/avatar-4.jpg')],
        status: '유효',
        date: '13 Oct, 19',
        comment: 175
    },
    {
        ...
        users: [require('@/assets/images/users/avatar-6.jpg'), 'D'],
        status: '만료',
        date: '14 Oct, 19',
        comment: 202
    },
    ...
    },
    {
        ...
        text: 'App Landing UI',
        subtext: 'For science, music, sport, etc',
        users: [require('@/assets/images/users/avatar-4.jpg'), 'D'],
        status: 'Completed',
        date: '11 Oct, 19',
        comment: 185
    },
